...
#4
EPAair_O3_17.skinny <- select(EPAair_O3_17, Date, DAILY_AQI_VALUE, Site.Name, 
                              AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
EPAair_O3_18.skinny <- select(EPAair_O3_18, Date, DAILY_AQI_VALUE, Site.Name,
                              AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
...
#6
write.csv(EPAair_O3_17.skinny, row.names = FALSE, 
          file ="../Data/Processed/EPAair_O3_NC2017_Processed.csv")
write.csv(EPAair_O3_18.skinny, row.names = FALSE, 
