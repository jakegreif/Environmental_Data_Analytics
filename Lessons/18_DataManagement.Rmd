...
#html_text() tells it to read the text in the html we're taking data from
...
#The "\\[.*\\]" is saying that if there are any spaces between words and a bracket remove them (first \\) and the part in brackets is saying remove anything within brackets.
riverdata$Name <- str_replace(riverdata$Name, "\n", "")
...
#We're asking it to read these fields as numeric, and substitute commas with nothing (R doesn't like commas in numeric elements)
